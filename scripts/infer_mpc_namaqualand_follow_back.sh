...
# 팔로우 샷 — 뒤에서 위에서 따라가며, 진행방향 쪽에 여백 (lead room)
...
# 팔로우: center=(0.35,0.45) 왼쪽 치우침 + lead room, 뒤+위에서 (fy=-0.7, fz=-0.5)
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1}" python scripts/infer_mpc_blender.py \
  ...
  --disable_roll \
  --target_json '{"center_x":0.35,"center_y":0.45,"occupancy":0.3,"aspect_ratio":1.2,"camera_to_object_fx":0.0,"camera_to_object_fy":-0.7,"camera_to_object_fz":-0.5,"camera_to_object_ux":0.0,"camera_to_object_uy":-0.5,"camera_to_object_uz":0.8}'
