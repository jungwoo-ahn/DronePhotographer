...
# 왼쪽에서: object forward가 카메라 기준 오른쪽을 향함 (fx≈1), 눈높이
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1}" python scripts/infer_mpc_blender.py \
  ...
  --target_json '{"bbox_centroid_offset":0.0,"bbox_occupancy_ratio":0.4,"camera_to_object_fx":1.0,"camera_to_object_fy":0.0,"camera_to_object_fz":0.0,"camera_to_object_ux":0.0,"camera_to_object_uy":0.0,"camera_to_object_uz":1.0}'
