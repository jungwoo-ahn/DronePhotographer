...
CUDA_VISIBLE_DEVICES=3 python scripts/infer_mpc_blender.py \
  --run_dir "${RUN_DIR}" \
  ...
  --target_json '{"bbox_occupancy_ratio":0.25,"bbox_margin_left":0.48,"bbox_margin_right":0.02,"bbox_margin_top":0.25,"bbox_margin_bottom":0.25,"bbox_aspect_ratio":1.0}'
