...
# 정면 눈높이: fy>0=정면(얼굴), 데이터 확인 fy≈+1.0 uz≈+1.0
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1}" python scripts/infer_mpc_blender.py \
  ...
  --target_json '{"bbox_centroid_offset":0.0,"bbox_occupancy_ratio":0.4,"camera_to_object_fx":0.0,"camera_to_object_fy":1.0,"camera_to_object_fz":0.0,"camera_to_object_ux":0.0,"camera_to_object_uy":0.0,"camera_to_object_uz":1.0}'
