...
# 바로 위에서: uy=cam_fwd·obj_up=-1 (확실), fz는 azimuth 의존 → 0으로 두고 weight 낮춤
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1}" python scripts/infer_mpc_blender.py \
  ...
  --target_json '{"bbox_centroid_offset":0.0,"bbox_occupancy_ratio":0.35,"camera_to_object_fx":0.0,"camera_to_object_fy":0.0,"camera_to_object_fz":0.0,"camera_to_object_ux":0.0,"camera_to_object_uy":-1.0,"camera_to_object_uz":0.0}'
