...
# 뒤쪽 위에서: fy<0=뒷면, 데이터 확인 fy≈-0.7 fz≈-0.5 uy≈-0.5 uz≈+0.8
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1}" python scripts/infer_mpc_blender.py \
  ...
  --target_json '{"bbox_centroid_offset":0.0,"bbox_occupancy_ratio":0.3,"camera_to_object_fx":0.0,"camera_to_object_fy":-0.7,"camera_to_object_fz":-0.5,"camera_to_object_ux":0.0,"camera_to_object_uy":-0.5,"camera_to_object_uz":0.8}'
