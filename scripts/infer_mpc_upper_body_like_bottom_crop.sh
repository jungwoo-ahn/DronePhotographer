...
DEFAULT_SCORE_WEIGHTS='{"bbox_occupancy_ratio":3.5,"bbox_margin_top":1.5,"bbox_margin_bottom":3.0,"bbox_margin_left":1.2,"bbox_margin_right":1.2,"bbox_aspect_ratio":1.5,"bbox_centroid_offset":1.0}'
...
CUDA_VISIBLE_DEVICES=4 python scripts/infer_mpc_blender.py \
  --run_dir "${RUN_DIR}" \
  ...
  --target_json '{"bbox_occupancy_ratio":0.60,"bbox_margin_top":0.06,"bbox_margin_bottom":0.0,"bbox_margin_left":0.18,"bbox_margin_right":0.18,"bbox_aspect_ratio":0.68}'
