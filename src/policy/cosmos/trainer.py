            ...
            for batch in dataloader_train:
                ...
                if accum >= cfg.grad_accum:
                    ...
                    if tb is not None:
                        ...
                        # Watch the goal prefix grow off 0 (goal_proj is zero-init):
                        # if this weight norm stays ~0, the goal condition never engaged.
                        tb.add_scalar("cond/goal_proj_norm",
                                      float(self.policy.conditioner.goal_proj.weight.detach().norm()), iteration)
